                            ...
                            <div class="container p-1">
                                ...
                                <ul class="nav nav-tabs p-1" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="gastos_generales-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="gastos_generales" aria-selected="true" onclick="Cargar_Nominas();">Registro Gastos Generales</button>
                                    </li>
                                </ul>
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="gastos_generales" role="tabpanel"
                                        ...
                                        <div class="form-hilos p-1 m-2 border border-1">
                                            <form method="POST" name="formulario_gastos_generales"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <label class="form-label mt-2" for="descrip">Descripcion:</label>
                                        ...
                                        <a class="btn btn-success m-3" id='btn_cierre' onclick="Realizar_Cierre();" disabled>Realizar Cierre de Gastos</a>
                                        <a class="btn btn-primary" onclick="Mostrar_Tabla(this,false);">Mostrar gastos</a>
...
<script src="../../js/gastos_generales.js"></script>
