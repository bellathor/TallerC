...
switch ($_SERVER['REQUEST_METHOD']) {
    case 'GET': // solicitud
        if (isset($_GET['consultar_maquinas'])) { // consulta todos los hilos
        ...
        } else if (isset($_GET['consultar_maquina'])) {  // consultar hilo en especifico
            $id = $_GET['id'];
            ...
            $inner = ' LEFT JOIN materiales mat on r.ID_Material = mat.ID_Material WHERE mat.Categoria = "Maquinas"';
