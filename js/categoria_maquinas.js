...
function Cargar_Hilos() {
    Fetch_GET(null, 'consultar_maquinas');
}
function Fetch_GET(id, opcion) {
    var url = '../../php/scripts/apis/bodega_taller/api_maquinas.php';

    if (opcion == 'consultar_maquinas') {
    ...
    } else if (opcion == 'consultar_maquina') {
        ...
        fetch(urlEnvio, {
            ...
            .then(datos => {
                if (datos.reportes != null) {
                    ...
                    alert('No hay reportes de maquinas.!');
                }
            })
            .catch(error => console.error("Error encontrado: ", error));
    }
...
function Seleccion_Materiales(seleccion) {
    ...
    if (seleccion.value != "Seleccionar") {
        Fetch_GET(seleccion.value, 'consultar_maquina');
        ...
        fetch(urlEnvio, {
            ...
            .then(datos => {
                if (datos.error == "false") {
                    ...
                    alert('Se hizo una salida de este material');
                } else {
                    alert('Hubo un problema con la base de datos.!');
                }
            })
